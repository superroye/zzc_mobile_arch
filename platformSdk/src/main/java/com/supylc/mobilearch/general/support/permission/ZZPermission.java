package com.supylc.mobilearch.general.support.permission;
...
import com.supylc.mobilearch.general.R;
...
public class ZZPermission {
    ...
    public static void openPermissionSetting(final Context context, List<String> permissions, Setting.Action action) {
        ...
        String message = context.getString(R.string.common_permission_message, TextUtils.join("\n", permissionNames));
