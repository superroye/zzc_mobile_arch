 ...
 */
public final class PostCache implements Closeable, Flushable {
    ...
    public final InternalCache internalCache = new InternalCache() {
        @Override public Response get(Request request) throws IOException {
            return PostCache.this.get(request);
        }

        @Override public CacheRequest put(Response response) throws IOException {
            return PostCache.this.put(response);
        }

        @Override public void remove(Request request) throws IOException {
            PostCache.this.remove(request);
        }

        @Override public void update(Response cached, Response network) {
            PostCache.this.update(cached, network);
        }

        @Override public void trackConditionalCacheHit() {
            PostCache.this.trackConditionalCacheHit();
        }

        @Override public void trackResponse(CacheStrategy cacheStrategy) {
            PostCache.this.trackResponse(cacheStrategy);
        }
    };
    ...
    public PostCache(File directory, long maxSize) {
        this(directory, maxSize, FileSystem.SYSTEM);
    }

    PostCache(File directory, long maxSize, FileSystem fileSystem) {
